...
<div class="content">
          ...
          <form method="post" action="" id="info">
		   ...
		   <table>
			...
			<div> 照片1：<input type="text" id="itemstartpicurl" name="itemstartpicurl" size="30" class="msgtext" style="width:50%;" >
				...
				<div> 菜系：<input type="text" id="itemtype" name="itemtype" size="30" class="msgtext" style="width:70%;" ></div>
		   </table>
		   </div>
			...
			<div> 照片1： <input type="text" id="addstartpicurl" id="addstartpicurl" size="30" class="msgtext" style="width:50%;" >
			 ...
			 <div>菜系：<input type="text" id="addtype" size="30" class="msgtext" style="width:70%;" ></div>
	...
	$("#itemrank").val(thisitem.children("td").eq(3).text());
	$("#itemtourl").val(thisitem.children("td").eq(5).text());
	$("#itemintro").val(thisitem.children("td").eq(7).text());
	$("#itemstartpicurl").val(thisitem.children("td").eq(8).children("img").attr("src"));
	$("#itemstartpicurl2").val(thisitem.children("td").eq(9).children("img").attr("src"));
	$("#itemstartpicurl3").val(thisitem.children("td").eq(10).children("img").attr("src"));
	$("#itemstartpicurl4").val(thisitem.children("td").eq(11).children("img").attr("src"));
	$("#itemtype").val(thisitem.children("td").eq(12).text());
